...
public class UsersController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create(UserRequestDto dto) => Ok(await _userService.CreateAsync(dto));

    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, UserRequestDto dto) { await _userService.UpdateAsync(id, dto); return NoContent(); }
