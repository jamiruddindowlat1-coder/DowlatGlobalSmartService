...
const PORTAL_COMPONENTS = {
  ...
  share_m_news: safeLazy(() => import('./ShareMarketServicePortal/ShareNewsBD')),
  ...
  return (
    <div style={{ background: '#000', minHeight: '100vh', width: '100%', fontFamily: 'sans-serif', color: '#fff' }}>
      ...
      <div style={{ 
        ...
        backgroundImage: 'url("https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Earth_and_Moon_seen_from_Mars.jpg/2560px-Earth_and_Moon_seen_from_Mars.jpg")', 
