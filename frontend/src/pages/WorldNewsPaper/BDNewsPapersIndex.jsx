...
const categories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'The Independent', web: 'https://www.theindependentbd.com' },
      { name: 'Dhaka Tribune', web: 'https://www.dhakatribune.com' },
      { name: 'Bangladesh Post', web: 'https://www.bangladeshpost.net' },
      { name: 'The Business Post', web: 'https://businesspostbd.com' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'RTV', web: 'https://www.rtvonline.com' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'বাংলাদেশ বেতার', web: 'https://www.betar.gov.bd' },
      { name: 'বাংলাদেশ টেলিভিশন (BTV)', web: 'https://www.btv.gov.bd' },
      { name: 'তথ্য অধিদফতর', web: 'https://www.pressinform.gov.bd' },
    ],
  },
  {
    name: 'আঞ্চলিক - ঢাকা',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'কক্সবাজার নিউজ', web: 'https://coxsbazarnews.com' },
    ],
  },
  {
    name: 'আঞ্চলিক - সিলেট',
    items: [
      ...
      { name: 'সিলেট টুডে', web: 'https://sylhettoday24.news' },
      { name: 'মৌলভীবাজার নিউজ', web: 'https://moulvibazarnews.com' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'সুন্দরবন নিউজ', web: 'https://sundarbannews.com' },
  ...
  },
  {
    name: 'আঞ্চলিক - বরিশাল',
    items: [
      { name: 'দৈনিক বরিশাল', web: 'https://www.dailybarisal.com' },
      { name: 'আজকের বরিশাল', web: 'https://ajkerbarisal.com' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'দৈনিক উত্তরবাংলা', web: 'https://www.uttarbangla.com' },
      { name: 'দিনাজপুর নিউজ', web: 'https://dinajpurnews.com' },
      ...
      { name: 'পঞ্চগড় নিউজ', web: 'https://panchagarhnews.com' },
    ],
  },
  {
    name: 'আঞ্চলিক - ময়মনসিংহ',
    items: [
      { name: 'আজকের ময়মনসিংহ', web: 'https://ajkermymensingh.com' },
      { name: 'ময়মনসিংহ প্রতিদিন', web: 'https://mymensinghpratidin.com' },
      { name: 'নেত্রকোনা নিউজ', web: 'https://netrokonanews.com' },
      { name: 'শেরপুর নিউজ', web: 'https://sherpurnews.com' },
  ...
  },
  {
    ...
    items: [
      { name: 'দৈনিক কুমিল্লা', web: 'https://www.dailycomilla.com' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'লক্ষ্মীপুর নিউজ', web: 'https://lakshmipurnews.com' },
    ],
  },
  {
    name: 'আঞ্চলিক - ফরিদপুর ও মাদারীপুর',
    items: [
      { name: 'গোপালগঞ্জ নিউজ', web: 'https://gopalganjnews.com' },
  ...
  },
  {
    ...
    items: [
      { name: 'টাঙ্গাইল নিউজ', web: 'https://tangailnews.com' },
      { name: 'মুন্সীগঞ্জ নিউজ', web: 'https://munshiganjnews.com' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'খেলার মাঠ', web: 'https://khelarmath.com' },
      { name: 'বিডি স্পোর্টস', web: 'https://bdsports24.com' },
  ...
  },
  {
    ...
    items: [
      { name: 'দ্যা ডেইলি ক্যাম্পাস', web: 'https://thedailycampus.com' },
      { name: 'ক্যাম্পাস লাইভ', web: 'https://campuslive24.com' },
  ...
  },
  {
    ...
    items: [
      { name: 'বিনোদন বার্তা', web: 'https://www.binodonbarta.com' },
  ...
  },
  {
    ...
    items: [
      { name: 'সাপ্তাহিক ২০০০', web: 'https://www.shaptahik2000.com' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'প্রবাস বাংলা', web: 'https://probasbd.com' },
