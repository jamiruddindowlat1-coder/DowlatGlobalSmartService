...
const subCategories = [
  {
    ...
    items: [
      ...
      { name: 'সাজেক ভ্যালি', web: 'https://www.bangladeshtourism.gov.bd' },
      { name: 'কুয়াকাটা', web: 'https://www.bangladeshtourism.gov.bd' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Shohoz Hotels', web: 'https://www.shohoz.com/hotels' },
  ...
  },
  {
    name: 'ট্যুর প্যাকেজ',
    items: [
      { name: 'Bangladesh Tourism Board', web: 'https://www.parjatan.gov.bd' },
      { name: 'Guide Tour BD', web: 'https://www.guidetour.com.bd' },
      { name: 'Bengal Tours', web: 'https://www.bengaltours.com' },
      { name: 'Truly Holidays', web: 'https://www.trulyholidays.com.bd' },
    ],
  },
  {
    name: 'ভিসা তথ্য',
    items: [
      { name: 'বাংলাদেশ ইমিগ্রেশন', web: 'https://www.dip.gov.bd' },
